...
public class PS_ArticleListAdapter extends ArrayAdapter<PS_Article> {
	private final Context context;
	private final ArrayList<PS_Article> articles;
	...
	public PS_ArticleListAdapter(Context context,
			ArrayList<PS_Article> articles) {
